...
/** Tests for {@link ClickHouseDataSinkFactory}. */
class ClickHouseDataSinkFactoryTest {

    @Test
    void testCreateDataSink() {
        DataSinkFactory sinkFactory =
                FactoryDiscoveryUtils.getFactoryByIdentifier("clickhouse", DataSinkFactory.class);
        Assertions.assertThat(sinkFactory).isInstanceOf(ClickHouseDataSinkFactory.class);

        Configuration conf =
                Configuration.fromMap(
                        ImmutableMap.<String, String>builder()
                                .put("url", "http://127.0.0.1:8123")
    ...
    void testLackRequireOption() {
        ...
        options.put("url", "http://127.0.0.1:8123");
        options.put("username", "default");
    ...
    void testUnsupportedOption() {
        ...
        Assertions.assertThatThrownBy(
                ...
                .isInstanceOf(ValidationException.class)
                .hasMessageContaining(
                        "Unsupported options found for 'clickhouse'.\n\n"
                                + "Unsupported options:\n\n"
                                + "unsupported_key");
    }
    ...
    void testCreateDataSinkWithSpecifiedTimeZone() {
        ...
        ZoneId zoneId = ((ClickHouseDataSink) dataSink).getZoneId();
        ...
        Configuration conf =
                Configuration.fromMap(
                        ImmutableMap.<String, String>builder()
                                ...
                                .put("password", "")
                                .put("database-name", "test_db")
                                .put("table.create.properties.engine", "MergeTree")
                                .build());
        DataSink dataSink =
                sinkFactory.createDataSink(
                        new FactoryHelper.DefaultContext(
